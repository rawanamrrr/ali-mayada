...
const ScratchToDiscover = () => {
      ...
      if (completedCount === 3) {
        ...
        const interval: any = setInterval(function() {
          ...
          confetti({ 
            ...
            colors: ['#d4af37', '#f6f7f3', '#b7aa9a', '#ffffff']
          })
        }, 100)
      }
      return newState
  ...
  return (
    <div className="min-h-[80vh] bg-[#ebebeb] overflow-x-hidden pt-0 pb-6">
      ...
      <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
        <div className="mb-12 flex flex-col items-center opacity-100">
          ...
          <div className="flex flex-col items-center gap-2">
            <ScratchCard width={100} height={100} onComplete={() => handleComplete(0)} shimmerColor="#dedad2" brushSize={45}>
              <div className="text-center">
                ...
                <p className="text-[10px] md:text-xs uppercase tracking-widest text-muted-foreground mt-0.5">{t('revealDayLabel')}</p>
              </div>
            </ScratchCard>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <ScratchCard width={100} height={100} onComplete={() => handleComplete(1)} shimmerColor="#dedad2" brushSize={45}>
              <div className="text-center">
                ...
                <p className="text-[10px] md:text-xs uppercase tracking-widest text-muted-foreground mt-0.5">{t('revealMonthLabel')}</p>
              </div>
            </ScratchCard>
          </div>
          ...
          <div className="flex flex-col items-center gap-2">
            <ScratchCard width={100} height={100} onComplete={() => handleComplete(2)} shimmerColor="#dedad2" brushSize={45}>
              <div className="text-center">
                ...
                <p className="text-[10px] md:text-xs uppercase tracking-widest text-muted-foreground mt-0.5">{t('revealYearLabel')}</p>
              </div>
            </ScratchCard>
          </div>
        </div>
        ...
        <AnimatePresence mode="wait">
          {allRevealed && (
            ...
            >
              <div className="absolute -top-20 left-1/2 -translate-x-1/2 w-px h-20 bg-gradient-to-b from-transparent via-[#661314]/50 to-[#661314]" />
              ...
              <motion.div 
                ...
                className="h-[1px] bg-gradient-to-r from-transparent via-[#661314]/20 to-transparent mx-auto mt-2"
              />
            </motion.div>
          )}
        </AnimatePresence>
